...
//
// SRZ80 local modification: keep MouseHoveredAddr updated while another byte
// editor is active, so host applications can update range selection live while
// the user drags across bytes.
